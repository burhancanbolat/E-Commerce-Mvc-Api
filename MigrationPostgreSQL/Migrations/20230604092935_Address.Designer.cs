...
namespace MigrationPostgreSQL.Migrations
{
    ...
    [Migration("20230604092935_Address")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PulsarECommerceData.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PulsarECommerceData.ShoppingCartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PulsarECommerceData.DeliveryAddress", b =>
                {
                    b.HasBaseType("PulsarECommerceData.Address");
            ...
            modelBuilder.Entity("PulsarECommerceData.InvoiceAddress", b =>
                {
                    b.HasBaseType("PulsarECommerceData.Address");
            ...
            modelBuilder.Entity("PulsarECommerceData.Order", b =>
                {
                    b.HasOne("PulsarECommerceData.DeliveryAddress", "DeliveryAddress")
                        .WithMany("Orders")
                        .HasForeignKey("DeliveryAddressId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PulsarECommerceData.InvoiceAddress", "InvoiceAddress")
                        .WithMany("Orders")
